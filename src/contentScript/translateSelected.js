...
Promise.all([twpConfig.onReady(), getTabHostName()]).then(function (_) {
  ...
  function init() {
        ...
        <div id="eDivResult" style="display: none">
            ...
            <div id="transTextContainer">
                ...
                <div class="action-buttons">
                    <div title="Listen" data-i18n-title="btnListen" id="listenTranslated">
                        <svg xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width="10px" height="10px" viewBox="0 0 93.038 93.038"
                    ...
                    <div title="Copy" data-i18n-title="btncopy" id="copy">
                    ...
                    <div title="Replace" data-i18n-title="btnReplace" id="replace" hidden>
                        <svg width="10" height="10" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <path
            ...
            <div id="origTextContainer" style="display: none">
                <div id="eOrigText" contentEditable="true" spellcheck="false" dir="auto"></div>
                <div class="orig-action-buttons">
                    <div title="Listen" data-i18n-title="btnListen" id="listenOriginal">
                        <svg xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width="10px" height="10px" viewBox="0 0 93.038 93.038"
                            style="enable-background:new 0 0 93.038 93.038;" xml:space="preserve">
                        <g>
                            <path d="M46.547,75.521c0,1.639-0.947,3.128-2.429,3.823c-0.573,0.271-1.187,0.402-1.797,0.402c-0.966,0-1.923-0.332-2.696-0.973
            ...
            <div id="drag">
                <div class="drag-row">
                    ...
                    <ul class="services-list">
                        ...
                        <li title="Libretranslate" id="sLibre" hidden>r</li>
                    </ul>
                </div>
            </div>
        </div>
    ...
    dragElement(
      shadowRoot.getElementById("eDivResult"),
      shadowRoot.getElementById("dragBar")
    );
      ...
      if (!darkMode) {
        el.textContent = `
                    #eDivResult {
                        ...
                        --action-bg: rgba(0,0,0,0.05);
                        --action-bg-hover: rgba(0,0,0,0.1);
                    }
                `;
      }
    ...
    const eToggleOriginal = shadowRoot.getElementById("toggleOriginal");
    ...
    if (
      ...
      eToggleOriginal.textContent = "\u25BE Hide original";
    } else {
      ...
      eToggleOriginal.textContent = "\u25B8 Show original";
    }
